...
export function actionCatalog(types=[]){
  ...
  return {version:ACTION_VERSION,scope:'asset-backed-studio',limits:{commandsPerBatch:32},
    ...
    relatedTools:['shutter_studio_context','shutter_inspect_source','shutter_search_moments','shutter_save_moment','shutter_get_direction','shutter_save_direction','shutter_propose_shots','shutter_inspect_cutaway'],
