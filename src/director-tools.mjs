...
export const directorTools=[
  ...
  ['shutter_propose_shots','Build up to 12 source candidates from the saved direction and marked moments at the observed timeline baseRevision and directionRevision. Returns source fit, authored notes and a concrete edit command per candidate. Does not apply or approve a take. Inspect source evidence and explain the choice, then preview/apply the chosen command using the editing tools. Rebuild if cut, notes or direction changed.',object({projectId:id,clipId:id,baseRevision:{type:'integer',minimum:1},directionRevision:{type:'integer',minimum:1}}),false]
];
