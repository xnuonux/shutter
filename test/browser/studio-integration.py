...
with sync_playwright() as p:
 ...
 try:
  page.goto(base+'/media-studio',wait_until='networkidle')
  ...
  page.reload(wait_until='networkidle');expect(page.locator('#editing')).to_be_visible()
  ...
  page.locator('#color-consent').check();page.locator('#render').click()
  ...
  page.locator('#program-host').scroll_into_view_if_needed();page.screenshot(path=str(OUT/'studio-desktop.png'))
  ...
  page.goto(base+'/#edit',wait_until='networkidle')
